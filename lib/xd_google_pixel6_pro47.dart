...
import './xd_google_pixel6_pro39.dart';
...
class XDGooglePixel6Pro47 extends StatelessWidget {
  const XDGooglePixel6Pro47({
    Key? key,
  }) : super(key: key);
  @override
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              duration: 0.2,
                              pageBuilder: () => const XDGooglePixel6Pro39(),
                            ),
                          ],
                          child: Stack(
                            children: <Widget>[
                          ...
                          child: PageLink(
                            links: [
                              PageLinkInfo(
                                ...
                                ease: Curves.easeInOut,
                                duration: 0.2,
                                pageBuilder: () => const XDGooglePixel6Pro35(),
                              ),
                            ],
                            child: Stack(
                              children: <Widget>[
