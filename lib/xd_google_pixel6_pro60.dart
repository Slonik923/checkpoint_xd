                    ...
                    Pinned.fromPins(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Padding(
                            padding:
                                EdgeInsets.fromLTRB(26.0, 18.0, 20.0, 19.0),
                            child: Stack(
                              children: <Widget>[
                                Align(
              ...
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child: Stack(
                    children: <Widget>[
                      Padding(
                        padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 10.4),
          ...
          Pinned.fromPins(
            ...
            child: PageLink(
              ...
              child: Stack(
                children: <Widget>[
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 0.0, 22.4, 0.0),
                    child: Stack(
                      children: <Widget>[
                        SizedBox.expand(
                            child: SvgPicture.string(
                  ...
                  Pinned.fromPins(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Padding(
                          padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 7.9),
                          child: SizedBox.expand(
                              child: SvgPicture.string(
                            _svg_g8h0ol,
                            allowDrawingOutsideViewBox: true,
