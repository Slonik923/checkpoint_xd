...
import './xd_google_pixel6_pro44.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDGooglePixel6Pro60 extends StatelessWidget {
  const XDGooglePixel6Pro60({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            ...
            Pin(size: 118.0, start: 107.0),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0x8088527f),
          ...
          Pinned.fromPins(
            ...
            Pin(size: 134.0, start: 121.0),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xbf88527f),
                borderRadius: BorderRadius.circular(10.0),
              ),
            ),
          ),
          ...
          Pinned.fromPins(
            ...
            Pin(size: 427.0, end: 129.0),
            child:
                // Adobe XD layer: 'Scroll Group 2 with…' (group)
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromPins(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Padding(
                            padding:
                                const EdgeInsets.fromLTRB(26.0, 18.0, 20.0, 19.0),
                            child: Stack(
                              children: <Widget>[
                                const Align(
                                ...
                                Align(
                                  alignment: const Alignment(-1.0, 0.135),
                                  child:
                                      // Adobe XD layer: 'RedLogoAsset 4' (shape)
                                      Container(
                                    width: 38.0,
                          ...
                          Pinned.fromPins(
                            ...
                            child: Stack(
                              children: <Widget>[
                                ...
                                Align(
                                  alignment: const Alignment(-1.0, 0.053),
                                  child:
                                      // Adobe XD layer: 'RedLogoAsset 4' (shape)
                                      Container(
                                    width: 32.0,
                    ...
                    Pinned.fromPins(
                      Pin(size: 203.0, middle: 0.5468),
                      Pin(size: 63.0, end: -446.0),
                      child: Stack(
                        children: <Widget>[
                          Pinned.fromPins(
                            Pin(start: 0.0, end: 0.0),
                            ...
                            child: const Text(
                              'Na dnes už žiadne iné kontroly.',
                              style: TextStyle(
                                fontFamily: 'Adobe Clean',
                                fontSize: 25,
                                color: Color(0xffffffff),
              ...
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child: Stack(
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 10.4),
          ...
          Pinned.fromPins(
            Pin(start: 35.0, end: 21.0),
            Pin(size: 556.0, middle: 0.4107),
            child: Stack(
              children: <Widget>[
                Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromPins(
                      ...
                      Pin(size: 97.0, start: 66.0),
                      child: const Text(
                        'Checkpoint ID#322\nPánske Toalety 2. Poschodie',
                        style: TextStyle(
                          fontFamily: 'Adobe Clean',
                          fontSize: 27,
                          color: Color(0xffffffff),
                    ...
                    Pinned.fromPins(
                      Pin(size: 150.0, end: 23.0),
                      Pin(size: 57.0, start: 3.0),
                      child: const Text(
                        'Kontrolný interval: 12:35-12:40',
                        style: TextStyle(
                          fontFamily: 'Adobe Clean',
                          fontSize: 20,
                          color: Color(0xffffffff),
                        ...
                        child: SizedBox(
                          ...
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromPins(
                                Pin(start: 0.0, end: 0.0),
                                Pin(size: 384.0, middle: 0.0),
                                child: const Text(
                                  'Skontrolovať celý priestor WC, vrátane podláh, kabíniek a pisoárov. Skontrolovať mydlo a utierky, pretrieť umývadlá. Ak niečo nie je v poriadku a čisté, vyčistiť a prípadnú úpravu zapísať ku kontrole v tejto aplikácii.',
                                  style: TextStyle(
                                    fontFamily: 'Adobe Clean',
                                    fontSize: 26,
                    ...
                    Pinned.fromPins(
                      Pin(size: 243.0, start: 27.0),
                      Pin(size: 19.0, middle: 0.7337),
                      child: const Text(
                        'Úlohy naviazané na tento Checkpoint:',
                        style: TextStyle(
                          fontFamily: 'Adobe Clean',
                          fontSize: 15,
                          color: Color(0xffffffff),
          ...
          Pinned.fromPins(
            Pin(size: 283.6, end: 53.0),
            Pin(size: 110.0, middle: 0.7123),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.8,
                  pageBuilder: () => XDGooglePixel6Pro44(),
                ),
              ],
              child: Stack(
                children: <Widget>[
                  Padding(
                    padding: const EdgeInsets.fromLTRB(0.0, 0.0, 22.4, 0.0),
                    child: Stack(
                      children: <Widget>[
                        SizedBox.expand(
                            child: SvgPicture.string(
                        ...
                        Pinned.fromPins(
                          Pin(size: 31.0, start: 9.6),
                          Pin(size: 50.0, middle: 0.5167),
                          child:
                              // Adobe XD layer: 'RedLogoAsset 4' (shape)
                              Container(
                            decoration: const BoxDecoration(
                  ...
                  Pinned.fromPins(
                    Pin(size: 13.6, end: 39.3),
                    Pin(size: 26.6, end: 12.2),
                    child: Stack(
                      children: <Widget>[
                        Padding(
                          padding: const EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 7.9),
                          child: SizedBox.expand(
                              child: SvgPicture.string(
                            _svg_g8h0ol,
                            allowDrawingOutsideViewBox: true,
...
const String _svg_h4oac4 =
    '<svg viewBox="0.0 0.0 261.3 110.0" ><path transform="translate(0.0, 0.0)" d="M 7.638888835906982 0 L 253.6111145019531 0 C 257.8299560546875 0 261.25 3.420047044754028 261.25 7.638888835906982 L 261.25 102.3611145019531 C 261.25 106.579948425293 257.8299560546875 110 253.6111145019531 110 L 7.638888835906982 110 C 3.420047044754028 110 0 106.579948425293 0 102.3611145019531 L 0 7.638888835906982 C 0 3.420047044754028 3.420047044754028 0 7.638888835906982 0 Z" fill="#bf3100" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_g8h0ol =
    '<svg viewBox="0.0 0.0 13.6 18.7" ><path transform="translate(-423.81, -215.02)" d="M 428.4425659179688 215.0229949951172 L 432.7354736328125 215.0229949951172 C 433.7401123046875 215.0229949951172 437.411865234375 218.6947174072266 437.411865234375 219.6993713378906 L 434.5543823242188 231.8788757324219 C 434.5543823242188 232.8835296630859 433.7401123046875 233.6977691650391 432.7354736328125 233.6977691650391 L 428.4425659179688 233.6977691650391 C 427.4379272460938 233.6977691650391 426.6236572265625 232.8835296630859 426.6236572265625 231.8788757324219 L 423.8080444335938 219.6575469970703 C 423.8080444335938 218.6529083251953 427.4379272460938 215.0229949951172 428.4425659179688 215.0229949951172 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="10" stroke-linecap="butt" /></svg>';
