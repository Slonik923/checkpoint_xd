...
class XDGooglePixel6Pro8 extends StatelessWidget {
  XDGooglePixel6Pro8({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(start: 51.6, end: 51.6),
            Pin(size: 270.5, middle: 0.4119),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 205.7, middle: 0.5),
                ...
                Padding(
                  padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 49.6),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(size: 166.2, start: -9.1),
                        Pin(size: 43.0, end: 52.5),
                      ...
                      Pinned.fromPins(
                        Pin(size: 266.0, end: -23.8),
                        Pin(start: 87.8, end: 90.2),
                        child: Transform.rotate(
                          angle: 2.3562,
                          child: Container(
                            decoration: BoxDecoration(
