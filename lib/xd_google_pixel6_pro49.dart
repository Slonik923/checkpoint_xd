...
import './xd_google_pixel6_pro48.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDGooglePixel6Pro49 extends StatelessWidget {
  const XDGooglePixel6Pro49({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: const Alignment(0.007, -0.347),
            child: SizedBox(
              width: 273.0,
              height: 145.0,
              child: Stack(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeInOut,
                  duration: 0.2,
                  pageBuilder: () => const XDGooglePixel6Pro48(),
                ),
              ],
              child: Stack(
                children: <Widget>[
