...
import './xd_google_pixel6_pro14.dart';
import 'dart:ui' as ui;
import 'package:flutter_svg/flutter_svg.dart';

class XDGooglePixel6Pro42 extends StatelessWidget {
  XDGooglePixel6Pro42({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 65.0, middle: 0.6457),
            child: Text(
              'Ďalšia kontrola o 60 minút',
              style: TextStyle(
              ...
              child: PageLink(
                links: [
                  PageLinkInfo(
                    ...
                    ease: Curves.linear,
                    duration: 0.2,
                    pageBuilder: () => XDGooglePixel6Pro14(),
                  ),
                ],
                child: Container(
          ...
          Pinned.fromPins(
            Pin(start: 24.0, end: -10.0),
            Pin(size: 462.0, start: 79.0),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 200.0, middle: 0.5802),
                  child: Container(
                    color: const Color(0xffffffff),
                  ),
                ),
                Align(
                  alignment: Alignment(0.434, 0.088),
                  child: Transform.rotate(
                    angle: -1.5708,
                    child: Container(
                      width: 52.0,
                ...
                Align(
                  alignment: Alignment(-0.578, 0.088),
                  child: Transform.rotate(
                    angle: -1.5708,
                    child: Container(
                      width: 52.0,
                ...
                Align(
                  alignment: Alignment(0.434, 0.358),
                  child: Transform.rotate(
                    angle: -1.5708,
                    child: Container(
                      width: 52.0,
                ...
                Align(
                  alignment: Alignment(-0.578, 0.358),
                  child: Transform.rotate(
                    angle: -1.5708,
                    child: Container(
                      width: 52.0,
                ...
                Align(
                  alignment: Alignment(0.434, -0.181),
                  child: Transform.rotate(
                    angle: -1.5708,
                    child: Container(
                      width: 52.0,
                ...
                Align(
                  alignment: Alignment(-0.578, -0.181),
                  child: Transform.rotate(
                    angle: -1.5708,
                    child: Container(
                      width: 52.0,
                ...
                Align(
                  alignment: Alignment(-0.111, -0.042),
                  child: SizedBox(
                    width: 102.0,
                    height: 33.0,
                    child: Transform.rotate(
                ...
                Align(
                  alignment: Alignment(0.467, -0.158),
                  child: SizedBox(
                    width: 66.0,
                    height: 19.0,
                    child: Text(
                ...
                Align(
                  alignment: Alignment(-0.572, -0.158),
                  child: SizedBox(
                    width: 66.0,
                    height: 19.0,
                    child: Text(
                ...
                Align(
                  alignment: Alignment(0.467, 0.077),
                  child: SizedBox(
                    width: 66.0,
                    height: 19.0,
                    child: Text(
                ...
                Align(
                  alignment: Alignment(-0.572, 0.077),
                  child: SizedBox(
                    width: 66.0,
                    height: 19.0,
                    child: Text(
                ...
                Align(
                  alignment: Alignment(0.467, 0.312),
                  child: SizedBox(
                    width: 66.0,
                    height: 19.0,
                    child: Text(
                ...
                Align(
                  alignment: Alignment(-0.65, 0.372),
                  child: SizedBox(
                    width: 44.0,
                    height: 19.0,
                    child: Text(
                ...
                Align(
                  alignment: Alignment(-0.646, 0.269),
                  child:
                      // Adobe XD layer: 'RedLogoAsset 4' (shape)
                      Container(
                    width: 19.0,
                ...
                Align(
                  alignment: Alignment(-0.388, 0.307),
                  child: Container(
                    width: 32.0,
                    height: 12.0,
