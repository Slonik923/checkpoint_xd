...
import './xd_google_pixel6_pro47.dart';
import './xd_google_pixel6_pro36.dart';
import './xd_google_pixel6_pro60.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDGooglePixel6Pro35 extends StatelessWidget {
  const XDGooglePixel6Pro35({
    Key? key,
  }) : super(key: key);
  @override
                          ...
                          child: PageLink(
                            links: [
                              PageLinkInfo(
                                ...
                                duration: 0.2,
                                pageBuilder: () => XDGooglePixel6Pro47(),
                              ),
                            ],
                            child: Stack(
                              children: <Widget>[
                          ...
                          child: PageLink(
                            links: [
                              PageLinkInfo(
                                ...
                                ease: Curves.linear,
                                duration: 0.2,
                                pageBuilder: () => XDGooglePixel6Pro36(),
                              ),
                            ],
                            child: Stack(
                              children: <Widget>[
                          ...
                          SizedBox.expand(
                            ...
                            links: [
                              PageLinkInfo(
                                ease: Curves.easeOut,
                                duration: 0.8,
                                pageBuilder: () => XDGooglePixel6Pro60(),
                              ),
                            ],
                            child: SvgPicture.string(
                              _svg_adlsz3,
