...
class XDGooglePixel6Pro37 extends StatelessWidget {
  XDGooglePixel6Pro37({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 92.0, middle: 0.17),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0x4088527f),
                borderRadius: BorderRadius.circular(10.0),
              ),
            ),
          ),
