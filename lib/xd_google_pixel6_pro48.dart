...
import './xd_google_pixel6_pro49.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDGooglePixel6Pro48 extends StatelessWidget {
  const XDGooglePixel6Pro48({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 273.0, middle: 0.5036),
            Pin(size: 229.0, start: 111.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 199.0, start: 26.0),
            Pin(size: 36.0, middle: 0.4124),
            child: const Text(
              'Pridať komentár',
              style: TextStyle(
                fontFamily: 'Adobe Clean',
          ...
          Pinned.fromPins(
            Pin(size: 37.9, start: 26.0),
            Pin(size: 44.7, middle: 0.7142),
            child: Stack(
              children: <Widget>[
                Align(
                ...
                Align(
                  alignment: const Alignment(-0.131, 0.092),
                  child: Container(
                    width: 13.0,
                    height: 11.0,
                    decoration: const BoxDecoration(
                ...
                Pinned.fromPins(
                  Pin(size: 13.2, middle: 0.4347),
                  Pin(size: 13.2, end: 4.7),
                  child: SvgPicture.string(
                    _svg_biy,
                    allowDrawingOutsideViewBox: true,
                    fit: BoxFit.fill,
                ...
                Pinned.fromPins(
                  Pin(size: 9.3, middle: 0.4435),
                  Pin(size: 9.3, end: 6.6),
                  child: Container(
                    decoration: const BoxDecoration(
                      color: Color(0xff000000),
                      borderRadius:
                ...
                Align(
                  alignment: const Alignment(0.615, 0.225),
                  child: Container(
                    width: 5.0,
                    height: 5.0,
                    decoration: const BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 138.0, end: 30.0),
            Pin(size: 62.0, middle: 0.8205),
            child:
                // Adobe XD layer: 'Button Posunúť ďalej' (component)
                const XDButtonPosunalej(),
          ),
          Pinned.fromPins(
            Pin(size: 18.8, end: 44.6),
            Pin(size: 35.4, start: 120.0),
            child: Stack(
              children: <Widget>[
                Align(
          ...
          ClipRect(
            child: BackdropFilter(
              ...
              child: Container(
                ...
                margin: const EdgeInsets.fromLTRB(-27.0, -10.0, 0.0, 117.0),
              ),
            ),
          ),
          Pinned.fromPins(
            Pin(start: 25.0, end: 25.0),
            Pin(size: 561.0, start: 111.0),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xff9f87af),
                borderRadius: BorderRadius.circular(10.0),
          ...
          Align(
            alignment: const Alignment(0.005, -0.156),
            child: SizedBox(
              width: 302.0,
              height: 491.0,
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              duration: 0.2,
                              pageBuilder: () => XDGooglePixel6Pro49(),
                            ),
                          ],
                          child: Stack(
                            children: <Widget>[
                              Stack(
                                children: <Widget>[
                                  ...
                                  Pinned.fromPins(
                                    Pin(size: 191.0, middle: 0.5818),
                                    Pin(size: 67.0, end: 9.4),
                                    child: const Text(
                                      'Pánske toalety,\n1. Poschodie',
                                      style: TextStyle(
                                        fontFamily: 'Adobe Clean',
                              ...
                              Pinned.fromPins(
                                Pin(size: 41.0, start: 14.0),
                                Pin(start: 30.0, end: 29.4),
                                child:
          ...
          Pinned.fromPins(
            Pin(size: 190.0, middle: 0.5045),
            Pin(size: 36.0, start: 123.0),
            child: const Text(
              'Aký Checkpoint',
              style: TextStyle(
                fontFamily: 'Adobe Clean',
          ...
          Pinned.fromPins(
            Pin(size: 203.0, middle: 0.4641),
            Pin(size: 31.0, end: 5.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),