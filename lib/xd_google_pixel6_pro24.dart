...
class XDGooglePixel6Pro24 extends StatelessWidget {
  XDGooglePixel6Pro24({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: SweepGradient(
                  ...
                  startAngle: 0.0,
                  endAngle: 6.2832,
                  colors: [const Color(0xffd86f6f), const Color(0xff133bc1)],
                  stops: [0.0, 1.0],
                  transform: GradientXDTransform(-0.695, 0.719, -0.719, -0.695,
