...
import './xd_google_pixel6_pro16.dart';
import 'package:adobe_xd/page_link.dart';
import './xd_google_pixel6_pro41.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDGooglePixel6Pro40 extends StatelessWidget {
  XDGooglePixel6Pro40({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.001, -0.152),
            child: SizedBox(
              width: 200.0,
              height: 232.0,
              child: PageLink(
                links: [
                  PageLinkInfo(
                    ...
                    duration: 0.8,
                    pageBuilder: () => XDGooglePixel6Pro16(),
                  ),
                ],
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromPins(
                      Pin(size: 99.3, middle: 0.5),
                      Pin(size: 96.7, start: 33.4),
                      child: Container(
                      ...
                      child: SizedBox(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Pinned.fromPins(
                              Pin(start: 7.7, end: 7.7),
                              Pin(size: 10.0, middle: 0.6362),
                              child: SvgPicture.string(
                                _svg_rtxi0i,
                                allowDrawingOutsideViewBox: true,
                                fit: BoxFit.fill,
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ease: Curves.easeIn,
                              duration: 0.4,
                              pageBuilder: () => XDGooglePixel6Pro41(),
                            ),
                          ],
                          child: Stack(
                            children: <Widget>[
...
const String _svg_l8ocz =
    '<svg viewBox="132.4 781.9 200.3 232.0" ><path transform="translate(-140.45, 758.6)" d="M 376.9195251464844 23.32899856567383 C 276.0106506347656 24.18082237243652 265.1627807617188 90.54679107666016 276.4427795410156 123.9789886474609 C 289.2541198730469 161.9506530761719 365.4953918457031 255.2720947265625 365.4953918457031 255.2720947265625 L 383.3310546875 255.3197631835938 C 383.3310546875 255.3197631835938 457.9855041503906 160.7250061035156 470.1534729003906 122.5411071777344 C 480.8667907714844 88.9229736328125 465.8903503417969 27.19286155700684 376.4883728027344 23.33192253112793" fill="#337cbc" stroke="none" stroke-width="6.504226207733154" stroke-miterlimit="10" stroke-linecap="butt" /></svg>';
const String _svg_qxgpik =
    '<svg viewBox="16.0 24.2 31.9 6.6" ><path transform="translate(-343.38, -84.32)" d="M 359.3789672851562 115.1374359130859 C 368.175537109375 106.3418426513672 382.4375610351562 106.3418426513672 391.234130859375 115.1374359130859" fill="none" stroke="#ffffff" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" /></svg>';
const String _svg_rtxi0i =
    '<svg viewBox="7.7 13.2 48.5 10.0" ><path transform="translate(-343.15, -84.02)" d="M 350.85400390625 107.2768936157227 C 364.23388671875 93.89704132080078 385.9273681640625 93.89704132080078 399.3075561523438 107.2768936157227" fill="none" stroke="#ffffff" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round" /></svg>';
const String _svg_molcz =
    '<svg viewBox="0.0 0.0 63.9 13.2" ><path transform="translate(-342.94, -83.66)" d="M 342.9420471191406 96.88209533691406 C 360.576171875 79.24795532226562 389.1661071777344 79.24795532226562 406.8000793457031 96.88209533691406" fill="none" stroke="#ffffff" stroke-width="4" stroke-miterlimit="10" stroke-linecap="round" /></svg>';
