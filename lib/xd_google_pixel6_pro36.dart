...
import './xd_google_pixel6_pro59.dart';
import './xd_google_pixel6_pro58.dart';
import './xd_google_pixel6_pro57.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDGooglePixel6Pro36 extends StatelessWidget {
  const XDGooglePixel6Pro36({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 46.0, end: 46.0),
            Pin(size: 134.0, middle: 0.6504),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
                    color: const Color(0xbf386641),
                    borderRadius: BorderRadius.circular(10.0),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.fromLTRB(26.0, 18.0, 20.0, 19.0),
                  child: Stack(
                    children: <Widget>[
                      const Align(
          ...
          Align(
            alignment: const Alignment(0.0, 0.643),
            child: SizedBox(
              width: 280.0,
              height: 118.0,
              child: Stack(
          ...
          Pinned.fromPins(
            Pin(size: 217.5, end: 0.0),
            Pin(size: 363.0, end: 107.0),
            child: Stack(
              children: <Widget>[
                Transform.rotate(
                  angle: 1.5708,
                  child: Container(
                    ...
                    margin:
                        const EdgeInsets.symmetric(horizontal: -72.8, vertical: 72.8),
                  ),
                ),
                Pinned.fromPins(
                  Pin(start: 22.5, end: 29.0),
                  Pin(size: 83.0, end: 52.0),
                  child: Stack(
                    children: <Widget>[
                      PageLink(
                        links: [
                          PageLinkInfo(
                            ...
                            duration: 0.2,
                            pageBuilder: () => XDGooglePixel6Pro59(),
                          ),
                        ],
                        child: Container(
                          decoration: BoxDecoration(
                            color: const Color(0xff8bc0e8),
                            borderRadius: BorderRadius.circular(10.0),
                            boxShadow: [
                              const BoxShadow(
                  ...
                  child: PageLink(
                    links: [
                      PageLinkInfo(
                        ...
                        ease: Curves.easeInOut,
                        duration: 0.2,
                        pageBuilder: () => XDGooglePixel6Pro58(),
                      ),
                    ],
                    child: Stack(
                      children: <Widget>[
                  ...
                  child: PageLink(
                    links: [
                      PageLinkInfo(
                        ...
                        ease: Curves.easeInOut,
                        duration: 0.2,
                        pageBuilder: () => XDGooglePixel6Pro57(),
                      ),
                    ],
                    child: Stack(
                      children: <Widget>[
